...
// ---------------------------------------------
        ...
        typescript: {
            build: {
                src: [
                    'scripts/pulsetotem-moderation.ts'
                ],
                dest: 'build/js/pulsetotem-moderation.js',
                options: {
                    module: 'commonjs',
                    basePath: 'scripts'
                }
        ...
        express: {
            ...
            build: {
                options: {
                    script: 'build/js/pulsetotem-moderation.js',
                    args: ["loglevel=debug"]
                }
            }
        },
...
// ---------------------------------------------
        watch: {
            express: {
                files:  [ 'build/js/pulsetotem-stats.js' ],
                tasks:  [ 'express:build' ],
                options: {
                    spawn: false
                }
...
// ---------------------------------------------
        yuidoc: {
            compile: {
                name: 'PulseTotem Moderation',
                description: 'Moderation for PulseTotem',
                version: '0.0.1',
